    ...
    <div className="py-14">
      <div className="min-h-[70vh]">
        {foodList.map((item, index) => {
          // console.log(item,cartItem,item._id)
                ...
                <div className="flex flex-col justify-between">
                  ...
                  <div className="flex justify-between items-center ">
                    ...
                    <span
                      ...
                      className="bg-green-900 px-2 flex items-center justify-center "
                    >
                      +
                    </span>
                  </div>
      ...
      <div className="py-2">
        ...
        <div className="flex w-full ">
          <input type="text" placeholder="promocode" className="w-[70%] py-2" />
          <button className="w-[30%] border">submit</button>
        </div>
      </div>
      <div className=" w-full">
        ...
        <div className="flex justify-between">
          <p>
            Price <span>{`( ${Object.keys(cartItem).length} item )`}</span>
          </p>
          <p>{getTotalCartAmount() + 5 * Object.keys(cartItem).length}</p>
        </div>
        <div className="flex justify-between ">
          <p>Discount</p>
          <p className="text-green-500">{`-${
            5 * Object.keys(cartItem).length
          }`}</p>
        </div>
        <div className="flex justify-between ">
        ...
        <button
          className="w-full flex items-center justify-center py-2 bg-green-900 font-semibold uppercase"
